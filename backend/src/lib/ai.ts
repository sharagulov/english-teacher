...
export const SCHEMAS = {
    ...
    writingPrompt: schema('writing_prompt', {
        prompt: str,
        promptRu: str,
    ...
    wordDeepDive: schema('word_deep_dive', {
        summary: str,
        senses: {
            type: 'array',
            items: {
    ...
    wordExamples: schema('word_examples', {
        items: {
            type: 'array',
            items: {
                type: 'object',
...
export const TUTOR_SYSTEM = 'Ты — опытный преподаватель английского языка для русскоговорящих студентов. ' +
