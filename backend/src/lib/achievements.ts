...
export const ACHIEVEMENTS: AchievementDefinition[] = [
  ...
  // Уровни: пороги совпадают с ощутимыми рубежами кривой рейтинга.
  ...
  { code: 'level_250', title: 'Двести пятьдесят', description: 'Поднять рейтинг до 250 уровня. Такое даётся годами.', category: 'rating', metric: 'ratingLevel', threshold: 250, points: 20_000 },
];
