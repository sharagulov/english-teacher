...
/** Монета рейтинга: круг + столбики роста — единая валютная иконка Lexio. */
export function RatingPointsIcon({
  size = 14,
  className,
}: {
  size?: number;
  ...
  return (
    ...
    >
      ...
      <path
        d="M4.25 10.75V8.75M6.75 10.75V6.25M9.25 10.75V4.75M11.75 10.75V7.25"
        stroke="currentColor"
        strokeWidth="1.35"
        strokeLinecap="round"
      />
...
export function RatingPoints({
  ...
  return (
    <span className={cx('inline-flex items-center gap-1', className)} title="Очки рейтинга">
...
/** Число с иконкой и словоформой «очко/очка/очков». */
export function RatingPointsLabel({
  amount,
  sign = '',
  className,
  valueClassName,
